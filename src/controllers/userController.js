...
const createUser = async function(req,res)
{
    ...
    let data = req.body
    let fethdata = await UserModel.create(data)
    res.send({msg:fethdata})
}
...
//     req.headers["month"]="November"
//     console.log("the month is",req.headers)
//     // console.log("Response header",req.month)
//     res.setHeader("message","Hi there!")
//     res.setHeader("month","November")
//     res.send({msg: "Hi"})
// }
